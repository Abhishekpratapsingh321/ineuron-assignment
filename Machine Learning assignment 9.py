...
get_ipython().set_next_input('2. What is feature selection, and how does it work? What is the aim of it? What are the various methods of function selection');get_ipython().run_line_magic('pinfo', 'selection')
...
get_ipython().set_next_input('3. Describe the function selection filter and wrapper approaches. State the pros and cons of each approach');get_ipython().run_line_magic('pinfo', 'approach')
...
4. Please Answer the following Questions :
   ...
   get_ipython().set_next_input('   Explain the key underlying principle of feature extraction using an example. What are the most widely used function extraction algorithms');get_ipython().run_line_magic('pinfo', 'algorithms')
...
get_ipython().set_next_input('8. State what is meant by "high-dimensional data set"? Could you offer a few real-life examples? What are the difficulties in using machine learning techniques on a data set with many dimensions? What can be done about it');get_ipython().run_line_magic('pinfo', 'it')
