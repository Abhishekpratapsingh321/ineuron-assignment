...
get_ipython().set_next_input('3. What is joint probability? What is its formula');get_ipython().run_line_magic('pinfo', 'formula')
...
get_ipython().set_next_input('4. What is chain rule of probability');get_ipython().run_line_magic('pinfo', 'probability')
...
get_ipython().set_next_input('5. What is conditional probability means? What is the formula of it');get_ipython().run_line_magic('pinfo', 'it')
...
get_ipython().set_next_input('6. What are continuous random variables');get_ipython().run_line_magic('pinfo', 'variables')
...
get_ipython().set_next_input('7. What are Bernoulli distributions? What is the formula of it');get_ipython().run_line_magic('pinfo', 'it')
...
get_ipython().set_next_input('8. What is binomial distribution? What is the formula');get_ipython().run_line_magic('pinfo', 'formula')
...
get_ipython().set_next_input('9. What is Poisson distribution? What is the formula');get_ipython().run_line_magic('pinfo', 'formula')
