...
get_ipython().set_next_input('7. How do you tell the difference between anomaly and novelty detection');get_ipython().run_line_magic('pinfo', 'detection')
...
get_ipython().set_next_input('8. What is a Gaussian mixture, and how does it work? What are some of the things you can do about it');get_ipython().run_line_magic('pinfo', 'it')
