...
get_ipython().set_next_input('1. What are the new features added in Python 3.8 version');get_ipython().run_line_magic('pinfo', 'version')
...
get_ipython().set_next_input('2. What is monkey patching in Python');get_ipython().run_line_magic('pinfo', 'Python')
...
get_ipython().set_next_input('3. What is the difference between a shallow copy and deep copy');get_ipython().run_line_magic('pinfo', 'copy')
...
get_ipython().set_next_input('4. What is the maximum possible length of an identifier');get_ipython().run_line_magic('pinfo', 'identifier')
...
get_ipython().set_next_input('5. What is generator comprehension');get_ipython().run_line_magic('pinfo', 'comprehension')
